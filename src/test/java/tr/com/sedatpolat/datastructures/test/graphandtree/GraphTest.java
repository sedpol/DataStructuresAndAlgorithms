...
public class GraphTest {
	...
	public void testGraph() {
		graph = new Graph<Movie>(Graph.TYPE.WEIGHT_ORDERED);
		...
		System.out.println("Suggestion for A: " + graph.suggestion(A));
		System.out.println("Suggestion for D: " + graph.suggestion(D));
